...
private fun AlarmListRoute(
    ...
    AlarmListScreen(
        ...
        onDeleteAlarmRequested = viewModel::onDeleteAlarmRequested,
        onConfirmDeleteAlarm = viewModel::onConfirmDeleteAlarm,
        onCancelDeleteConfirmation = viewModel::onCancelDeleteConfirmation,
        onEditAlarm = onEditAlarm,
        onOpenSettings = onOpenSettings,
        onOpenManualCreate = onOpenManualCreate,
        onOpenAiCreate = onOpenAiCreate,
