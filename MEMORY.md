...
- Alarm management is now part of the AI alarm agent surface: `list_alarms`, `pause_alarm`, and `resume_alarm` must stay routed through `AlarmManagementUseCase`, while `create_alarm`, `reject_unclear_request`, `end_task`, and required-tool policy remain intact.
