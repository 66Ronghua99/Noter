...
- Paused-next resume should preserve a future checkpoint, but if the checkpoint is already stale it must recalculate from the current clock before scheduling.
...
- Direct alarm-agent list intent includes common existence phrasing such as "do I have any alarms?" in addition to list/show/display/what/which forms; keep management verbs as blockers.
